...
(function() {
    try {
        ...
        i.prototype.init = function() {
                ...
                this.n && !0 !== this.s && (this.s = !0, (i = document.createElement("div")).id = "crisp-loader", document.getElementsByTagName("body")[0].appendChild(i), n = function() {
                    ...
                    s.f = setTimeout(function() {
                        s.f = null, s.y -= s.v, void 0 !== window[s.w] && "function" == typeof window[s.w].__init && !0 === n() ? (s.x.info(s.ns + "." + e, "Dependencies loaded"), i.parentNode.removeChild(i), window[s.w].__init({
                            ...
                            page_url: s.np,
                            page_domain: s.sp,
                            browser_useragent: s.ep,
                            browser_timezone: s.rp,
                            browser_capabilities: s.op,
                            browser_locales: s.cp,
                            ready_trigger: s.hp,
                            runtime_configuration: s.ap,
            ...
            try {
                null !== this.f && clearTimeout(this.f), this.Rs(), this.init()
            } catch (t) {}
        }, i.prototype.up = function() {
            try {
                this.dp("dns-prefetch", this.ms), this.dp("preconnect", this._e), this.fp(), this.pp()
            } catch (t) {}
        }, i.prototype.dp = function(t, i) {
            try {
                var n = document.createElement("link");
                n.setAttribute("href", i), n.setAttribute("rel", t), n.setAttribute("crossorigin", ""), this.lp(n), document.getElementsByTagName("head")[0].appendChild(n)
            } catch (t) {}
        }, i.prototype.fp = function() {
            try {
                var t = document.createElement("script");
                t.src = [this._e + "/", this._p + "/", "client.js?" + this._a].join(""), t.type = "text/javascript", t.async = 1, this.lp(t), document.getElementsByTagName("head")[0].appendChild(t)
            } catch (t) {}
        }, i.prototype.pp = function() {
            try {
                var t = this.mp(),
                    i = document.createElement("link");
                i.href = [this._e + "/", this.Ip + "/", "client_" + t + ".css?" + this._a].join(""), i.type = "text/css", i.rel = "stylesheet", this.lp(i), document.getElementsByTagName("head")[0].appendChild(i)
            } catch (t) {}
        }, i.prototype.Rs = function() {
            this.yp(), this.vp(), this.wp()
        }, i.prototype.yp = function() {
            this.s = !1, this.f = null, this.y = this.Cp, this._f = document.domain, this.np = document.location.href, this.sp = document.location.hostname, this.ep = window.navigator.userAgent, this.rp = (new Date).getTimezoneOffset(), this.cp = this.Rp(), "string" == typeof CRISP_WEBSITE_ID && CRISP_WEBSITE_ID ? this.n = CRISP_WEBSITE_ID : this.n = this.Sp(), "string" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.tp = CRISP_TOKEN_ID : "number" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.tp = CRISP_TOKEN_ID.toString() : this.tp = null, "number" == typeof CRISP_COOKIE_EXPIRE && 0 < CRISP_COOKIE_EXPIRE ? this.dn = CRISP_COOKIE_EXPIRE : this.dn = null, "string" == typeof CRISP_COOKIE_DOMAIN && CRISP_COOKIE_DOMAIN ? this.ip = CRISP_COOKIE_DOMAIN : this.ip = null, "function" == typeof CRISP_READY_TRIGGER ? this.hp = CRISP_READY_TRIGGER : this.hp = {}, "object" === ("undefined" == typeof CRISP_RUNTIME_CONFIG ? "undefined" : t(CRISP_RUNTIME_CONFIG)) ? this.ap = CRISP_RUNTIME_CONFIG : this.ap = {}, "object" === ("undefined" == typeof CRISP_INCLUDE_ATTRS ? "undefined" : t(CRISP_INCLUDE_ATTRS)) ? this.Ep = CRISP_INCLUDE_ATTRS : this.Ep = {}
        }, i.prototype.vp = function() {
            try {
                this.op = [], "function" == typeof window.MutationObserver && "function" == typeof JSON.stringify && this.op.push("browsing"), ("function" == typeof window.RTCPeerConnection && "object" === t(navigator.mediaDevices) && "https:" === document.location.protocol && (window.innerWidth || 0) >= this.gp && (window.innerHeight || 0) >= this.bp || !0 === this.Pp) && this.op.push("call")
            } catch (t) {}
        }, i.prototype.wp = function() {
            var t;
            try {
                this.ap.locale && (-1 !== (t = this.cp.indexOf(this.ap.locale)) && this.cp.splice(t, 1), this.cp.unshift(this.ap.locale))
            } catch (t) {}
        }, i.prototype.lp = function(t) {
            try {
                for (var i in this.Ep) this.Ep.hasOwnProperty(i) && t.setAttribute(i, this.Ep[i])
            } catch (t) {}
        }, i.prototype.Sp = function() {
            var t = null;
            try {
                for (var i = document.querySelectorAll("script[src]"), n = 0; n < i.length; n++) {
                    var s = this.Tp.exec(i[n].src);
            ...
            try {
                ...
                if (!0 !== s && (-1 === i.indexOf("opera mini/") && -1 === i.indexOf("msie") && -1 === n.indexOf("trident/") || (s = !0)), !0 !== s)
                    for (var e = 0; e < this.Op.length; e++) {
                        var r = this.Op[e],
                            o = i.match(r.pattern);
            ...
            var t = !0;
            try {
                !(window.innerWidth && window.innerWidth < this.Np) && !0 === navigator.cookieEnabled && !0 !== this.Kp(this.sp) && !0 !== this.kp(this.ep) && window.WebSocket || (t = !1)
            } catch (t) {} finally {
                return t
            }
            ...
            try {
                if (t)
                    for (var n = 0; n < this.Ap.domains.length; n++) {
                        var s = this.Ap.domains[n],
                            e = "." + s;
            ...
            try {
                if (t)
                    for (var n = 0; n < this.Ap.agents.length; n++)
                        if (-1 !== t.indexOf(this.Ap.agents[n])) {
                            i = !0;
                            break
                        }
            } catch (t) {} finally {
    ...
    function i() {
        ...
        try {
            this.ns = "CrispLoader", this.x = {
                ...
                log: function() {},
                debug: function() {}
            }, this.Pp = !1, this.on = "crisp-client", this.jp = "client.crisp.chat", this.Gp = "client.relay.crisp.chat", this.Up = "stream.relay.crisp.chat", this._a = "75d9fae", this.do = "production", this.xp = "https:", this.$s = "https://crisp.chat", this.fn = "https://go.crisp.chat", this._n = "https://image.crisp.chat", this.fs = "https://game.crisp.chat", this.ms = this.xp + "//" + this.Gp, this.ws = this.xp + "//" + this.Up, this._e = this.xp + "//" + this.jp, this.io = [{
                ...
                domains: [],
                agents: ["Trident", "Googlebot", "Bingbot", "Slurp", "DuckDuckBot", "Baiduspider", "YandexBot", "GTmetrix", "Lighthouse", "Acunetix"]
            }, this._p = "static/javascripts", this.Ip = "static/stylesheets", this.w = "$__CRISP_INSTANCE", this.Bp = "$__CRISP_INCLUDED", this.v = 100, this.Cp = 3e4, this.Lp = 1e3, this.Np = 280, this.gp = 320, this.bp = 420, this.Op = [{
                pattern: /edg(?:e)?\/([0-9\.]+)/,
                version: 79
            }, {
                ...
                pattern: /android ([0-9\.]+)/,
                version: 5
            }], this.Tp = /(?:http\:|https\:)?\/\/[^\/]+\/l\/([a-zA-Z0-9\-_]+)\.js/i, this.Rs(), !0 === window[this.Bp] || void 0 !== window[this.w] && "function" == typeof window[this.w].__init || !0 !== this.Dp() || (window[this.Bp] = !0, "interactive" === document.readyState || "complete" === document.readyState ? this.init() : (t = document.onreadystatechange || function() {}, window.addEventListener("DOMContentLoaded", function() {
                i.init()
